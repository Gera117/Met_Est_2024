# Minimo 3 grupos.
# Permite comprobar si existen diferencias significativas entre las medias de dos o más grupos y determinar si las diferencias son significativas.
...
paraje <-read.csv("Datos Anova GC.csv", header=T)
